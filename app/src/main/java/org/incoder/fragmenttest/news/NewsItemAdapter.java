...
import org.incoder.fragmenttest.news.NewsItemFragment.OnListFragmentInteractionListener;
...
public class NewsItemAdapter extends RecyclerView.Adapter<NewsItemAdapter.ViewHolder> {
    ...
    public NewsItemAdapter(List<DummyItem> items, OnListFragmentInteractionListener listener) {
        mValues = items;
        mListener = listener;
    }
